    ...
    @empty
        <div class="flex justify-center mt-4">
            <div class="text-center">
                ...
                <div><span class="text-gray">│   </span><span class="text-cyan font-bold">Nothing trending right now</span><span class="text-gray">   │</span></div>
                <div class="text-gray">│                             │</div>
                <div><span class="text-gray">│  </span><span class="text-white">Check back soon for updates</span><span class="text-gray">  │</span></div>
                <div class="text-gray">│                             │</div>
                <div class="text-cyan">╰─────────────────────────────╯</div>
            </div>
        </div>
